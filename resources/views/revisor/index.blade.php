<x-main>
    ...
    <div class="container pt-5 mt-5">
        ...
        <section class="row">
            ...
            <h2 class="text-center fw-bold fst-italic pb-4">{{$announce_to_check->title}}</h2>
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item @if($image == $announce_to_check->images()->first()) active @endif">
                            <img style="width: 400px; height: 450px;" src="{{Storage::url($image->path)}}" class="d-block w-100 mb-5" alt="Foto Annuncio">
        ...
        <section class="row pt-5 mt-5">
            <div class="col-12">
                <p class="text-center">{{ __('ui.noRevAd') }} <a href="{{route('revisor.revised')}}" class="btn btn-secondary">{{ __('ui.adRevised') }}</a></p>
            </div>
        </section>
        @endif
    </div>
