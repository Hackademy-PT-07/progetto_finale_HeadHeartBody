    ...
    <div class="container">
            ...
            <div class="col-4 col-xl-2 p-2 m-xl-1 text-center">
                <a class="m-0 link-offset-2 link-underline link-underline-opacity-0" href="{{route('hp.announces.category', $category->id)}}">
                    <div class="card card-bdash">
                        ...
                        <p>{{__('ui.category_'.$category->id)}}</p>
                    </div>
                </a>
            </div>
            @endforeach
        ...
        <section class="row py-4">
            ...
            <section class="row d-flex justify-content-center">
                ...
                <div class="col-10 text-center formTitle my-5">
                    <a href="{{route('announces.index')}}">
                        <h4 class="text-capitalize fs-9 text-decoration-underline" id="firstTitle">Annunci recenti</h4>
                    </a>
                </div>
                <div class="col-1"></div>
            ...
            <section class="row d-flex align-items-center">
                ...
                <div class="py-3">
                    <h2 class="text-center fw-bold fst-italic">{{ __('ui.workWithUsForm') }}</h2>
                </div>
                ...
                <div class="py-3">
                    <h2 class="text-center fw-bold fst-italic">Contatta l'amministratore</h2>
                </div>
