<x-main>
    ...
    <div class="container d-flex justify-content-center col-6 py-5">
        <div class="row py-3">
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade pb-3">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="homeImg" src="https://img.freepik.com/free-vector/worldwide-connection_53876-90449.jpg?w=740&t=st=1691689711~exp=1691690311~hmac=0934f82063cc1b8c644a50a5bf785da3eaf7cb4065825136de5ab364307e533e" class="img-fluid" alt="Foto promo">
                        ...
                        <div class="carousel-item">
                            <img class="homeImg" src="https://img.freepik.com/premium-photo/top-view-happy-easter-background_1921-1186.jpg?w=740" class="img-fluid" alt="Foto promo">
                            <div class="carousel-caption d-none d-md-block textShadow">
                        ...
                        <div class="carousel-item">
                            <img class="homeImg" src="https://img.freepik.com/free-photo/vehicles-boxes-supply-chain-representation_23-2149853158.jpg?w=740&t=st=1691689210~exp=1691689810~hmac=fc239f90cbaecb45565ce335fe3469640f410cf714240f90b5f4dbdcceb0445f" class="img-fluid" alt="Foto promo">
                            <div class="carousel-caption d-none d-md-block textShadow">
